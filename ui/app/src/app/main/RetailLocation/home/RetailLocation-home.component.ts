...
@Component({
  selector: 'RetailLocation-home',
  templateUrl: './RetailLocation-home.component.html',
  styleUrls: ['./RetailLocation-home.component.scss']
})
export class RetailLocationHomeComponent implements AfterViewInit {
