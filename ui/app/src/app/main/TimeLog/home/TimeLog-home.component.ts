...
@Component({
  selector: 'TimeLog-home',
  templateUrl: './TimeLog-home.component.html',
  styleUrls: ['./TimeLog-home.component.scss']
})
export class TimeLogHomeComponent implements AfterViewInit {
