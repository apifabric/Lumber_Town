...
@Component({
  selector: 'CustomerOrder-home',
  templateUrl: './CustomerOrder-home.component.html',
  styleUrls: ['./CustomerOrder-home.component.scss']
})
export class CustomerOrderHomeComponent implements AfterViewInit {
