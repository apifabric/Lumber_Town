...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CustomerOrder, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.RetailLocation, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.TimeLog, method_decorators= method_decorators)
    return api
