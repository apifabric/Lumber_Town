...
resourcename="lumbertown"  # lower case, only
resourcegroup="lumbertown_rg"
...
# git clone https://github.com/apilogicserver/lumbertown.git
# cd lumbertown
...
az group create --name lumbertown_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group lumbertown_rg --sku S1 --is-linux
az container create --resource-group lumbertown_rg --name lumbertown --image apilogicserver/lumbertown:latest --dns-name-label lumbertown --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//lumbertown.westus.azurecontainer.io:5656'
